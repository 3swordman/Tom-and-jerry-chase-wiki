...
export const characterRelationCharacterCounterTraits: CharacterRelationTrait[] = [
  ...
  {
    description: '天使泰菲的庇护免疫三级{闪现}的控制效果，使其追击困难',
    relation: {
      kind: 'counters',
      subject: { name: '天使泰菲', type: 'character' },
  ...
  {
    description:
      '泰菲的{圆滚滚}能够避免被斯飞的{狂}、{猎}、配合扑击一波杀死；圆滚滚不易被斯飞卡真空期；{火箭炮}会对斯飞造成减速，有一定的干扰作用',
    relation: {
      kind: 'counters',
      subject: { name: '泰菲', type: 'character' },
      target: { name: '斯飞', type: 'character' },
  ...
  {
    description: '恶魔杰瑞两个技能均有较长前摇，被莱特宁3级闪现克制，且不惧怕刷盾与中小距离流放。',
    relation: {
      kind: 'counters',
  ...
  },
  {
    ...
    relation: {
      ...
      target: { name: '莱特宁', type: 'character' },
      tags: [{ counters: '辅助', counteredBy: '怕辅助' }],
      isMinor: false,
    },
  },
  {
  ...
  {
    description: '凯特被动提供减控和攻击增伤，克制罗菲的控制。但凯特Hp不高，要小心被罗菲直接击倒。',
    relation: {
      kind: 'counters',
      subject: { name: '凯特', type: 'character' },
      target: { name: '罗宾汉泰菲', type: 'character' },
      tags: [
        { counters: '高伤', counteredBy: '怕高伤' },
        { counters: '不惧', counteredBy: '怕不惧' },
      ],
      isMinor: true,
    },
  },
  ...
  {
    description:
      '前期国王杰瑞的护盾能够被斯飞疾冲状态的感电效果轻易破掉，同时国王杰瑞难以逃离斯飞追击。',
    relation: {
      kind: 'counters',
      subject: { name: '斯飞', type: 'character' },
      target: { name: '国王杰瑞', type: 'character' },
  ...
  {
    description:
      'Lv.1{随机应变}赋予侍卫汤姆较快移速，容易追杀机动性差的泰菲；Lv.2随机应变赋予侍卫高伤，可以秒杀泰菲；{警戒}赋予侍卫汤姆大范围视野，使侍卫汤姆很难被远程{火箭炮}命中；{炮弹}命中敌方会使侍卫汤姆自身获得两层{护盾}，可以抵消火箭弹两段伤害和{爆炸眩晕(状态)}；炮弹命中泰菲会禁用{圆滚滚}，导致泰菲无法用圆滚滚解控。',
    relation: {
      kind: 'counters',
      subject: { name: '侍卫汤姆', type: 'character' },
      target: { name: '泰菲', type: 'character' },
      isMinor: false,
      tags: [
        { counters: '追击', counteredBy: '怕追击' },
        { counters: '高伤', counteredBy: '怕高伤' },
        { counters: '大视野', counteredBy: '怕大视野' },
        { counters: '免疫', counteredBy: '怕免疫' },
      ],
    },
  },
  {
    description:
      'Lv.1{心思缜密}赋予塔拉较高移速，十分容易追杀机动性差的泰菲；Lv.2{心思缜密}赋予塔拉较大视野，使其较难被远程{火箭炮}命中；Lv.3{心思缜密}赋予塔拉的{免控}可以有效规避火箭炮和地雷的{爆炸眩晕(状态)}；{弹簧仙人球}可无视圆滚滚{无敌(状态)}将泰菲强制位移，防守能力极强，导致泰菲无法利用Lv.2{茁壮成长}推奶酪或者救援队友',
    relation: {
      kind: 'counters',
  ...
  {
    description:
      '牛汤使用鞭子获得永久加成后速度较快，容易追杀机动性差的泰菲；泰菲的{感应雷}能协助牛仔汤姆卡时间使用{斗牛}鞭尸触发Lv.2{游刃有余}；{鞭子}CD短，极容易卡{圆滚滚}真空期；{鞭子}和{斗牛}可以将火箭炮销毁；牛汤的Lv.3游刃有余在泰菲受伤状态下可以无视泰菲Lv.2{茁壮成长}减伤直接秒杀泰菲；',
    relation: {
      kind: 'counteredBy',
      subject: { name: '泰菲', type: 'character' },
      target: { name: '牛仔汤姆', type: 'character' },
  ...
  {
    description:
      '恶汤{迷乱列车}冷却时间短，且可储存多次，泰菲{圆滚滚}解控后冷却时间长，不可储存，容易在技能真空期被恶汤利用易伤磨死；恶汤开启{狂欢时刻}会获得{霸体}，能有效规避泰菲{火箭炮}和{地雷}的{爆炸眩晕}',
    relation: {
      kind: 'counteredBy',
      subject: { name: '泰菲', type: 'character' },
      target: { name: '恶魔汤姆', type: 'character' },
  ...
  {
    description:
      '泰菲Hp较低，被凯特的{骄傲的学霸}叠加{破绽}状态后容易被秒杀；Lv.2{骄傲的学霸}加持下赋予凯特较快移速，容易追杀机动性差的泰菲；泰菲的{火箭炮}和{感应雷}控制时间较短，凯特在Lv.2{骄傲的学霸}的减控加持下被命中可快速起身。',
    relation: {
      kind: 'counteredBy',
      subject: { name: '泰菲', type: 'character' },
      target: { name: '凯特', type: 'character' },
      ...
      tags: [
        { counters: '高伤', counteredBy: '怕高伤' },
        { counters: '追击', counteredBy: '怕追击' },
        { counters: '减控', counteredBy: '怕减控' },
      ],
    },
  },
  {
    description:
      '苏蕊攻击手段多，LV.1{少女心}可以刷新{瑜伽球}CD，容易卡{圆滚滚}真空期；苏蕊的瑜伽球伤害较高，容易压制Hp低的泰菲；苏蕊开启{律动时间}会获得{跳舞免控}，可有效免疫{火箭炮}的{感应雷}的{爆炸眩晕(状态)}',
    relation: {
      kind: 'counteredBy',
      subject: { name: '泰菲', type: 'character' },
      target: { name: '苏蕊', type: 'character' },
  ...
  {
    description:
      '莱特宁的追击能力强，容易追杀机动性差的泰菲；{瞬移闪击}和{咸鱼}CD较短，容易卡{圆滚滚}真空期；{垃圾桶}可以抵挡{火箭炮}；二级咸鱼可免疫火箭炮和{感应雷}的{爆炸眩晕(状态)}；Lv.1{穷追不舍}可以压制Hp低的泰菲',
    relation: {
      kind: 'counteredBy',
      subject: { name: '泰菲', type: 'character' },
      target: { name: '莱特宁', type: 'character' },
  ...
  {
    description:
      '泰菲的{圆滚滚}可以避免被布奇的{横冲直撞}、{垃圾盖}或{旋转桶盖}一波杀死；圆滚滚不易被布奇卡真空期；泰菲的{感应雷}有碰撞体积，可撞走旋转桶盖规避伤害；',
    relation: {
      kind: 'counters',
      subject: { name: '泰菲', type: 'character' },
      target: { name: '布奇', type: 'character' },
  ...
  {
    description: '凯特二级被动会导致剑客杰瑞华尔兹剑舞或者格挡无法与剑与苹果形成配合进行二次连控。',
    relation: {
      kind: 'counters',
      subject: { name: '凯特', type: 'character' },
      target: { name: '剑客杰瑞', type: 'character' },
  ...
  {
    description:
      '罗宾汉杰瑞的降落伞和加速不怕图茨的喵喵叫和汽水罐。但图茨的技能眩晕时间长且眩晕均在伤害后追加，因此罗宾被控后不好跑路。',
    relation: {
      kind: 'counters',
      subject: { name: '罗宾汉杰瑞', type: 'character' },
      target: { name: '图茨', type: 'character' },
  ...
  },
  {
    ...
    relation: {
      ...
      subject: { name: '罗宾汉泰菲', type: 'character' },
      target: { name: '剑客汤姆', type: 'character' },
      tags: [{ counters: '控制', counteredBy: '怕控制' }],
      isMinor: false,
    },
  },
  {
  ...
  {
    description: '米可的减伤使胡椒粉难以造成伤害；照相机回溯可以舍己救人后不会因为胡椒粉而虚弱。',
    relation: {
      kind: 'counters',
      subject: { name: '米可', type: 'character' },
      target: { name: '米特', type: 'character' },
  ...
  {
    description: '牛仔汤姆攻击易波及鲍姆，会使其提前被引爆；技能提供直接抓取效果，克制鲍姆的高Hp。',
    relation: {
      kind: 'counters',
      subject: { name: '牛仔汤姆', type: 'character' },
      target: { name: '鲍姆', type: 'character' },
  ...
  {
    description:
      '泰菲的{圆滚滚}可以避免被剑客汤姆的{骑士连斩}与{旋刃剑舞}的连招一波杀死；圆滚滚不易被未点Lv.3{骑士之剑}的剑客汤姆卡真空期；泰菲的角色模型矮，骑士连斩第三段很多情况会被无视无法锁定；剑汤本身除骑士连斩的短暂{无敌(状态)}外并无其他无敌霸体技能，容易被{火箭炮}和{感应雷}干扰；泰菲在剑客汤姆连斩友方过程中释放{感应雷}，可能炸飞队友或眩晕剑客汤姆，也有少量帮助；剑汤很难对点了Lv.2{茁壮成长}推奶酪的泰菲造成有效伤害',
    relation: {
      kind: 'counters',
      subject: { name: '泰菲', type: 'character' },
      target: { name: '剑客汤姆', type: 'character' },
  ...
  {
    description:
      '{火箭炮}和{感应雷}可以对缺少{无敌(状态)}{霸体}技能的图茨造成有效干扰；{圆滚滚}可以免疫或解除{喵喵叫}、{汽水罐(衍生物)}的伤害和眩晕；圆滚滚不易被没到6级的图茨卡真空期，但后期能被卡真空期。',
    relation: {
      kind: 'counters',
      subject: { name: '泰菲', type: 'character' },
      target: { name: '图茨', type: 'character' },
  ...
  {
    description: '汤姆无敌挡伤害和干扰，二级锅解决124血量快，且剑杰推速和救援能力差。',
    relation: {
      kind: 'counters',
      subject: { name: '汤姆', type: 'character' },
      target: { name: '剑客杰瑞', type: 'character' },
  ...
  },
  {
    ...
    relation: {
      ...
      subject: { name: '天使汤姆', type: 'character' },
      target: { name: '剑客莉莉', type: 'character' },
      tags: [{ counters: '不惧', counteredBy: '怕不惧' }],
      isMinor: false,
    },
  },
  {
  ...
  {
    description: '爱之花洒无法提前浇灭因50线索值而放飞的火箭',
    relation: {
      kind: 'counters',
      subject: { name: '侦探汤姆', type: 'character' },
      target: { name: '雪梨', type: 'character' },
  ...
  {
    description: '皇家盔甲可以穿过风墙，且侍卫汤姆克制莉莉二级被动。',
    relation: {
      kind: 'counters',
      subject: { name: '侍卫汤姆', type: 'character' },
      target: { name: '剑客莉莉', type: 'character' },
  ...
  {
    description: '库博的放飞机制无视天使杰瑞的天使祝福。',
    relation: {
      kind: 'counteredBy',
      subject: { name: '天使杰瑞', type: 'character' },
      target: { name: '库博', type: 'character' },
