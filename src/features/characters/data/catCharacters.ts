...
const catCharacterDefinitions = {
  ...
  汤姆: {
    ...
    skillAllocations: [
      ...
      },
      {
        ...
        pattern: '131[3300]01',
        weaponType: 'weapon2',
        description: '非常顺风的时候可以考虑先点被动再点平底锅。',
        additionaldescription: '血量告急时，可以考虑先点2级被动回血。',
      },
    ],
    knowledgeCardGroups: [
      {
    ...
    skills: [
      {
        ...
        type: 'active',
        aliases: ['无敌'],
        description: '立刻解除眩晕等控制效果，然后进入一段时间的无敌，无敌结束后短暂减速。',
        detailedDescription:
          '立刻[解除眩晕等控制效果](不包括番茄减速等减速效果)，然后进入一段时间的无敌。前摇期间获得[弱霸体](不免疫虚弱和部分变身效果，且会被冰面打断)。无敌期间加速12.5%，[免疫大部分道具和技能的负面效果](包括会免疫尼宝-尼宝的朋友造成的眩晕效果（不免疫位移）；免疫仙女鼠-星星棒的8星变身效果)，但[仍会受到部分特殊技能影响](不免疫尼宝-尼宝的朋友造成的位移效果（会免疫眩晕）；不免疫仙女鼠-星星棒的1/2/4/6星的效果，且仙女鼠-星星棒的8星仍可打断交互；若在莱恩蓝图内受到仙女鼠的伤害，会变成线条猫；不免疫部分改变或创造地形类的技能)。无敌结束后减速10%，持续2秒，可被护盾抵消。汤姆在前摇和无敌期间不会被斯派克索敌。如果被斯派克抓起，可以用该技能解除眩晕，但不可免疫位移。',
        ...
        skillLevels: [
          ...
          {
            level: 2,
            description: '无敌持续时间延长。',
            detailedDescription: '无敌持续时间延长到6.8秒。',
            cooldown: 20,
          },
          {
            level: 3,
            description: '无敌期间爪刀CD缩短。',
            detailedDescription: '无敌期间爪刀CD缩短25%。',
            cooldown: 20,
          },
        ],
      },
      {
        ...
        type: 'weapon1',
        description:
          '释放{手型枪(衍生物)}水平飞出、飞回，对命中的老鼠造成少量伤害、将其抓回并眩晕。若拉回途中[遇到障碍](包括墙壁、叉子的阻挡、或某些高低差地形)，则额外造成高额伤害。',
        detailedDescription:
          '释放{手型枪(衍生物)}水平飞出、飞回，对[命中](飞出、飞回过程均可命中；包括因遇到护盾而提前返回的情况；至多只能抓回并眩晕一只老鼠)的老鼠造成{15*,可致伤}伤害、[将其抓回并眩晕2.5秒](本技能造成伤害与造成眩晕的时机不同，所以即便该老鼠因该次伤害而进入"铁血"状态，也仍会受到后续的拉回和眩晕影响)。若拉回过程[遇到障碍](包括墙壁、叉子的阻挡、或某些高低差地形)，则[额外](单次手枪可能重复产生2-3次伤害，具体成因不详，疑似与墙壁厚度及高低差有关)造成{70*,不受来源影响,不可致伤}伤害。抓回及眩晕效果对变身状态或虚弱的老鼠也生效。若手型枪命中有护盾的老鼠，则打破一层护盾并提前返回。',
      ...
      },
      {
        ...
        detailedDescription:
          '挥锅攻击，对直接命中的老鼠造成{15*,不可致伤}伤害，向斜上方略微击飞对方，并附加5秒{失明}（[有特殊显示特效](特效为一块煎蛋蒙蔽双眼，与常规失明不同)）和55%救援减速效果；被平底锅直接命中并击飞的老鼠[落地](若该角色被老鼠夹夹住，则需挣脱后才会判定落地)后受到{30*,不可致伤}伤害，并眩晕1秒。\n挥锅同时会以固定角度和力度飞出一块{煎蛋}，煎蛋对命中的老鼠造成{15*,可致伤}点伤害，并附加5秒{失明}（[有特殊显示特效](特效为一块煎蛋蒙蔽双眼，与常规失明不同)）和55%救援减速效果。\n挥锅命中部分道具/衍生物（无论其是否已被投掷）时，会将其以“被汤姆投掷”向最近的老鼠(若有)的状态击飞。', //todo:add 会被击飞的道具列表
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: ['道具键'],
        ...
        skillLevels: [
          ...
          {
            level: 2,
            description: '煎蛋失明持续时间延长；平底锅命中老鼠时将刷新爪刀CD。',
            detailedDescription:
              '煎蛋失明持续时间延长至7.5秒；平底锅击飞老鼠，或{煎蛋}命中[老鼠](包括虚弱等状态下的老鼠)时，刷新爪刀CD。',
            cooldown: 18,
          },
          {
            level: 3,
      ...
      },
      {
        ...
        skillLevels: [
          {
            level: 1,
            description: '对敌方造成伤害时，短暂加速。手握老鼠时可以使用爪刀。',
            detailedDescription:
              '对敌方造成伤害时，加速10%，持续2.6秒。手握老鼠时可以使用爪刀，但[不改变惯性](即不因使用爪刀而进入下落状态)。',
          },
          {
            level: 2,
            description: '对敌方造成伤害时，回复Hp并缩短主动技能CD。',
            detailedDescription: '对敌方造成伤害时，回复25Hp并缩短主动技能3秒CD。',
          },
          {
            level: 3,
            description: '对敌方造成伤害时，短暂禁用其技能与道具，并掉落手中的道具。',
            detailedDescription: '对敌方造成伤害时，3秒内禁用其技能与道具，并掉落手中的道具。',
          },
        ],
      },
    ],
  ...
  布奇: {
    ...
    catPositioningTags: [
      ...
      },
      {
        tagName: '进攻',
        level: 4,
        description: '自身伤害较高，且{旋转桶盖}有不错的上火箭能力',
        ...
        skillLevels: [
          {
            ...
            detailedDescription:
              '虚弱时间缩短至3.8秒，且[虚弱期间的Hp恢复速度增加至100Hp/秒](该效果保证了绝大多数情况下布奇将以满Hp状态起身)，虚弱结束后的无敌时间延长。',
          },
          {
            level: 2,
            description:
          ...
          },
          {
            level: 3,
            description:
              '爪刀有一定概率额外造成极高伤害，[若同时命中多只老鼠则只会触发一次](该特性源自用户补充，暂未进行进一步测试)；技能和部分道具造成的控制时间延长1秒。',
            detailedDescription:
              '爪刀有30%概率[额外](与原伤害分为不同的两段)造成{200*,无来源}伤害（原爪刀命中护盾时不造成额外伤害），[若同时命中多只老鼠则只会触发一次](该特性源自用户补充，暂未进行进一步测试)；技能和部分道具对敌方造成的控制时间延长1秒。',
          },
        ],
      },
    ],
    ...
    knowledgeCardGroups: [
      {
        cards: [
          ...
          'A-穷追猛打',
          'B-皮糙肉厚',
          [CardGroupType.Or, 'A-熊熊燃烧', [CardGroupType.And, 'A-加大火力', 'C-猫是液体']],
        ],
        description:
          '利用{击晕}配合{1级被动}提高控制能力，或是配合{捕虫网}直接抓住老鼠；{皮糙肉厚}提高分身的生存能力，{穷追猛打}提高前期找节奏能力。剩下6点配{熊熊燃烧}，如果是管道图就带{猫是液体}，再带{加大火力}弥补火箭燃烧效率不足的问题。',
      },
      {
        cards: ['S-击晕', 'S-乘胜追击', 'A-熊熊燃烧'],
        description:
          '{乘胜追击}提高机动性，且能更好地配合{击晕}和{1级被动}。但缺少{皮糙肉厚}的减伤和{穷追猛打}的前期找节奏能力，所以需要更多的注意分身的状态，同时推荐在有{七色花}的地图使用，弥补前期缺少找节奏能力的问题。',
      },
      {
        cards: ['S-击晕', 'A-熊熊燃烧', 'A-长爪', 'B-皮糙肉厚'],
        description:
          '托普斯爪刀较短，{长爪}能极大幅提高爪刀范围，配合{击晕}、{1级被动}和{我生气了！}打出连续控制和爆发伤害，还能刷取经验。但{长爪}负面效果也很明显，需要权衡利弊再使用。',
      },
      {
        cards: ['S-击晕', 'S-知识渊博', 'A-熊熊燃烧', 'C-猫是液体'],
        description: '适用于管道图的另一种配卡，{知识渊博}提供的大量经验让托普斯更早进入强势期。',
      },
    ],
    ...
    skills: [
      {
        ...
        aliases: ['分身', '弟弟'],
        description:
          '释放一个{托普斯分身}。分身爪刀伤害提高，爪刀CD缩短，免疫碎片和老鼠夹，且[继承部分知识卡](大多数知识卡均可继承，其中部分知识卡效果还与本体叠加（如“捕鼠夹”的伤害和控制时间延长效果可以二次叠加）；但部分特殊知识卡不继承或继承后无效果（如“熊熊燃烧”等）)。分身[共享小地图视野](由于人工智能类角色具有能看到隐身角色的特性，因此分身也能在小地图上透视周围隐身的老鼠，但不会主动攻击)，但[受到的伤害增加](包括受到部分环境伤害时)。本体[获得部分增益时](包括食物、药水效果，以及部分地图道具效果（如太空堡垒-科研舱药水等）)，分身也会获得。\n\n分身存在期间本体获得额外技能，点击可指挥分身出击或跟随（有CD）。\n再次使用主动技能可与分身换位（有[单独CD](与技能原本的CD无关；不受增加/缩减冷却的效果影响)）。',
        detailedDescription:
          '释放一个{托普斯分身}，其[与自身相貌相同](装扮、昵称、Hp条显示的方式和本体完全一致)。分身爪刀伤害提高15，爪刀CD缩短至3.2秒，免疫碎片和老鼠夹，且[继承部分知识卡](大多数知识卡均可继承，其中部分知识卡效果能与本体叠加（如“捕鼠夹”的伤害和控制时间延长效果可以二次叠加）；但部分特殊知识卡不继承或继承后无效果（如“熊熊燃烧”等）)。分身[共享小地图视野](由于人工智能类角色具有能看到隐身角色的特性，因此分身也能在小地图上透视周围隐身的老鼠，但不会主动攻击)，但[受到的伤害增加20](包括受到部分环境伤害时)。本体[获得部分增益时](包括食物、药水效果，以及部分地图道具效果（如太空堡垒-科研舱药水等）)，分身也会获得。\n\n分身存在期间本体获得额外技能，点击可指挥分身出击或跟随（CD：5秒）\n出击：根据本体朝向前进，遇到障碍物会尝试跳跃过去，失败则原路返回。\n跟随：向本体跟随。\n\n分身存在期间再次使用主动技能可与分身换位（有[单独CD](与技能原本的CD无关；不受增加/缩减冷却的效果影响)，与技能等级有关）。\n\n分身成功释放后，技能本身的CD就开始倒计时；分身被击倒或消失后，技能切换回本来的CD。',
        canMoveWhileUsing: false,
        canUseInAir: false,
        cancelableSkill: '不可主动打断',
        cancelableAftercast: '无后摇',
        skillLevels: [
          ...
          {
            level: 2,
            description: '换位CD缩短至10秒；换位时回复Hp，且移速和交互速度提高，持续6秒。',
            detailedDescription:
              '换位CD缩短至10秒；换位时，本体和分身均回复50Hp，且移速提高20%、交互速度提高25%，持续6秒。',
            cooldown: 24,
          },
          {
            level: 3,
            description:
              '换位CD缩短至5秒；分身不会主动消失；如果分身在本体附近，本体受到的[眩晕控制](包括大部分眩晕，另外还能免疫尼宝的鱼钩；不包括其它控制，如斯派克抓取、捕鼠夹、虚弱、仙女鼠8星等)和受到的一半伤害会转移给分身。',
            cooldown: 20,
          },
        ],
        forecast: 2.2,
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '击中老鼠时，[移除其部分增益效果](包括{牛奶}、{隐身饮料}、{远视饮料}、{兴奋饮料}、{隐身}、{鼓舞}加速、{降落伞}落地加速、{二段跳}、{身轻如燕}、{剑与苹果}、{剑舞华尔兹}、{闪电救援}救援成功后加速、{地狱裂隙}加速等)。',
          },
        ],
      },
    ],
        ...
        groups: [
          {
            cards: [
              ...
              'A-熊熊燃烧',
              'A-穷追猛打',
              [CardGroupType.Or, 'A-心灵手巧', 'B-皮糙肉厚'],
            ],
            description: '无管道用。对面伤害高就带皮糙肉厚，否则就带心灵手巧',
          },
          {
        ...
        groups: [
          {
            ...
            description: '搭配二武{咸鱼}使用，偏打架，伤害高，但对投掷与爪刀的精准度要求较高。',
          },
          {
    ...
    skills: [
      {
        ...
        skillLevels: [
          ...
          {
            level: 2,
            description: '瞬移后获得8秒“疾如风”状态（移速提高、爪刀CD缩短）。',
            cooldown: 8,
            detailedDescription: '瞬移后获得8秒“疾如风”状态（移速提高10%、爪刀CD缩短50%）。',
          },
          {
            level: 3,
            description:
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '放置{垃圾桶(衍生物)}阻挡道路，可被推动且被猫推动时的力度更大，可被爪刀打飞，受到4次攻击后会摧毁。垃圾桶的异味会对老鼠造成伤害并减少爪刀CD。',
        detailedDescription:
          '放置{垃圾桶(衍生物)}阻挡道路，可被推动且被猫推动时的力度更大，可被爪刀打飞，受到4次攻击后会摧毁。垃圾桶的异味会对老鼠造成伤害。每次伤害时减少爪刀CD，每秒只生效一次。垃圾桶造成的伤害不会使老鼠虚弱，但仍会持续减少爪刀CD。垃圾桶不会对已虚弱的老鼠造成伤害，也不会因此降低爪刀CD，在垃圾桶范围内倒地并起身的老鼠不会受到垃圾桶的伤害，但重新进入垃圾桶范围仍会受到伤害。',
        canMoveWhileUsing: false,
        canUseInAir: false,
        cancelableSkill: ['跳跃键'],
        cancelableAftercast: '无后摇',
        ...
        skillLevels: [
          ...
          },
          {
            level: 2,
            description:
              '垃圾桶持续时间延长至18秒；提高伤害。垃圾桶会对Hp降至最低的老鼠造成1秒眩晕，每5秒触发一次。',
            cooldown: 18,
            detailedDescription:
              '垃圾桶持续时间延长至18秒；进入垃圾桶范围改为造成{18.75*,固定,不可致伤}伤害，后续改为每秒受到{10*,固定,不可致伤}伤害。垃圾桶会对Hp降至最低的老鼠造成1秒眩晕，每5秒触发一次。',
          },
          {
            level: 3,
            description: '提高伤害。',
            cooldown: 18,
            detailedDescription:
              '提高减速效果；进入垃圾桶范围改为造成{31.25*,固定,不可致伤}伤害，后续改为每秒受到{15*,固定,不可致伤}伤害。',
          },
        ],
      },
      {
        ...
        detailedDescription:
          '从垃圾桶中倒出{咸鱼(衍生物)}并标记在小地图上，咸鱼在一分钟后或被敌方踩到后会消失。敌方踩到咸鱼后会受其影响，推速降低40%，救援、治疗速度降低30%，移速降低10%，跳跃高度降低10%，同时暴露小地图位置，持续20秒。可通过吃{蛋糕}、喝{牛奶}、喝{饮料（组合）}、{应急治疗}、{2级牛仔吉他}来解除。爪刀命中[带有咸鱼效果的敌方](包括虚弱老鼠)时，将重置瞬移闪击CD，爪刀CD缩短至1.9秒，并获得50Hp/秒的恢复效果，持续1秒。瞬移闪击将优先追踪带有咸鱼效果的敌方，并大幅提高追踪范围；手中有老鼠时，则优先追踪最近的咸鱼。\n使用技能后一段时间内，可通过二段技能投掷一条{咸鱼-投射物}，命中老鼠产生与咸鱼相同的效果，命中其它物体则会直接消失。\n本技能在未加点时也会进行冷却。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableSkill: ['跳跃键'],
        cancelableAftercast: '无后摇',
        ...
        skillLevels: [
          ...
          },
          {
            ...
            charges: 2,
            detailedDescription:
              '受咸鱼影响的[敌方](包括猫咪)无法对莱特宁造成眩晕、且无法自然恢复Hp。',
          },
          {
            level: 3,
            ...
            cooldown: 8,
            charges: 2,
            detailedDescription: '咸鱼腥味的持续时间延长至30秒。',
          },
        ],
      },
      {
    ...
    knowledgeCardGroups: [
      {
        id: '鞭子',
        description:
          '若想更快进行等级压制，则推荐带{知识渊博}；若想追求放飞速度，则推荐携带{熊熊燃烧}；若是管道图，则可考虑{加大火力}+{猫是液体}。',
        groups: [
          {
            cards: [
              'S-击晕',
              ...
              [
                ...
                'S-知识渊博',
                'A-熊熊燃烧',
                [CardGroupType.And, 'A-加大火力', 'C-猫是液体'],
              ],
            ],
            description: '',
          },
      ...
      },
      {
        id: '弹弓防守流',
        description:
          '若选择带{熊熊燃烧}，则有更快的放飞速度；若选择带{皮糙肉厚}+{反侦察}，则牺牲了放飞速度但更不易被击倒，且反侦察还能提供额外经验。',
        groups: [
          {
            cards: [
              'S-知识渊博',
              'A-细心',
              'A-穷追猛打',
              [CardGroupType.Or, 'A-熊熊燃烧', [CardGroupType.And, 'B-皮糙肉厚', 'B-反侦察']],
            ],
            description: '',
          },
        ],
          ...
          },
          {
            cards: [
              ...
              [
                CardGroupType.Or,
                'A-熊熊燃烧',
                [CardGroupType.And, 'C-猫是液体', [CardGroupType.Or, 'A-加大火力', 'A-心灵手巧']],
              ],
            ],
            description:
              '面对打架队使用，如果同时是管道图，{熊熊燃烧}换成{加大火力}或{心灵手巧}（打强控制队）+{猫是液体}',
          },
        ],
        defaultFolded: true,
      },
    ...
    skills: [
      {
        ...
        detailedDescription:
          '释放{斗牛(衍生物)}，斗牛会来回冲撞，破坏[部分道具](包括玻璃杯/碗/盘子/扁盘/灰花瓶/蓝花瓶/香水瓶/胡椒瓶，以及纸盒、吊灯、牛仔杰瑞的仙人掌等)，并对老鼠造成{25*,不受来源影响,不可致伤}伤害和1.5秒{眩晕}（内置CD：4秒），被牛眩晕的老鼠可以被直接抓取。斗牛每次撞墙或老鼠减少1秒持续时间，撞到墙体或插入地板的叉子会掉头，[会带走已经布置的老鼠夹](在某些情况下，斗牛在碰到打开的老鼠夹之后也会掉头，并弹飞老鼠夹)。每个牛仔汤姆最多同时召唤2头斗牛，超过时最先生成的斗牛会消失。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: ['跳跃键', '道具键'],
        cancelableAftercast: '无后摇',
        ...
        skillLevels: [
          {
            ...
            detailedDescription:
              '向前喇叭形发射三颗{小仙人掌球}，命中时造成{16*,不受来源和减伤影响,可致伤}伤害、获得老鼠的小地图位置4.85秒，同时自身获得持续5.85秒的12%加速。小仙人掌球最多存在1.5秒。',
            cooldown: 18,
          },
          {
            level: 2,
          ...
          },
          {
            ...
            cooldown: 18,
            detailedDescription:
              '7秒内可进行第三次发射，发射一颗{大仙人掌球}，在碰触实体时爆炸，对周围的敌方造成{50*,不受来源和减伤影响,不可致伤}伤害和3.5秒眩晕，同时分裂成10颗{小仙人掌球}飞向不同方向。',
          },
        ],
    ...
    skills: [
      {
        ...
        skillLevels: [
          ...
          {
            level: 3,
            description: '被吻命中的老鼠禁用技能，进一步增加吻对老鼠的伤害。',
            cooldown: 15,
            charges: 2,
            detailedDescription:
              '吻痕期间，老鼠禁用技能；伤害改为每次跳跃受到{2.3*,不受来源影响,不可致伤}伤害，移动期间以折合11.3Hp/秒的速度受到伤害，搬动奶酪以折合32Hp/秒的速度受到伤害。',
          },
        ],
        cueRange: '全图可见',
        aliases: ['吻'],
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            level: 2,
            description:
              '提高香水释放次数和释放状态持续时间。图多盖洛获得的恢复效果增强，且额外提高攻击增伤、缩短爪刀CD；对敌方的减益数值增强。',
            cooldown: 16,
            detailedDescription:
              '香水自然释放频率提高至0.8秒/次（自然释放次数增加到18次）。\n图多盖洛在香水内获得的恢复效果改为15Hp/秒，且攻击增伤提高25，爪刀CD缩短30%；敌方在香水区域内移速改为降低55%，跳跃速度改为降低20%，推速改为降低30%，[造成的伤害改为降低20](最低为0)。',
          },
          {
            level: 3,
            description:
              '图多盖洛获得的所有香水增益效果数值全面增强，且额外提高爪刀范围；对敌方减益数值进一步增强，且使其禁用技能。',
            cooldown: 16,
            detailedDescription:
              '图多盖洛在香水内获得的恢复效果改为20Hp/秒，攻击增伤改为提高50，爪刀CD改为缩短70%，且爪刀范围提高到300；敌方在香水区域内移速改为降低80%，跳跃速度改为降低30%，推速改为降低70%，[造成的伤害改为降低30](最低为0)，且禁用技能。',
          },
        ],
        canHitInPipe: false,
        cooldownTiming: '释放时',
        ...
        groups: [
          {
            cards: [
              ...
              'A-熊熊燃烧',
              'A-心灵手巧',
              [CardGroupType.Or, 'A-穷追猛打', 'A-加大火力', 'B-皮糙肉厚'],
            ],
            description:
              '{穷追猛打}适合新手入门，{加大火力}能提升放飞速度，{皮糙肉厚}适用于对抗高伤阵容，如{剑客杰瑞}、{朵朵}。',
          },
        ],
    ...
    skills: [
      ...
      },
      {
        ...
        skillLevels: [
          ...
          {
            level: 3,
            description: '火炮能射击七次；使命中的老鼠减速、并禁用技能与道具键一段时间。',
            cooldown: 25,
            detailedDescription: '火炮能射击七次；使命中的老鼠减速40%、并禁用技能与道具键3.5秒。',
          },
        ],
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '以自身为中心，半径范围1757内老鼠数量为1或2只时，自身增加25点攻击力，爪刀CD缩短25%。',
          },
          {
            level: 3,
            description:
    ...
    skillAllocations: [
      {
        ...
        pattern: '121210002',
        weaponType: 'weapon1',
        description: '防狼锤综合强度较低，仅在需要利用其2级的沉默效果时才推荐使用。',
        additionaldescription: '',
      },
      {
        id: '汽水罐常规加点',
    ...
    knowledgeCardGroups: [
      {
        cards: [
          ...
          'A-熊熊燃烧',
          'A-穷追猛打',
          [CardGroupType.Or, 'A-细心', 'B-皮糙肉厚'],
        ],
        description:
          '通用卡组。\n{细心}适合碎片多和夹子比较多的大地图，如雪夜古堡全系列，太空堡垒1、2，游轮3等，萌新可以无脑用这套\n。若将{细心}换为{皮糙肉厚}，则更需要手法，萌新不推荐。适合夹子少、碎片少、布局收益不大的大地图，如经典之家全系列，游乐场，熊猫馆，酒店，天宫。',
      },
      {
        cards: [
          'A-熊熊燃烧',
          ...
          [
            CardGroupType.Or,
            [CardGroupType.And, 'A-心灵手巧', 'B-捕鼠夹'],
            [CardGroupType.And, 'A-心灵手巧', 'C-猫是液体'],
            [CardGroupType.And, 'A-加大火力', 'B-捕鼠夹'],
          ],
        ],
        description:
          '**（1）**{心灵手巧}+{捕鼠夹}适合夹子多的图，很克{舍己}，特定地图很强，如游轮1、2，太空堡垒2、也可以考虑太空堡垒3使用。注意，如果有破局老鼠，要斟酌使用，可改用上方{乘胜追击}搭配{细心}那一套。**（2）**{心灵手巧}+{猫是液体}适合管道多的图，如太空堡垒3、森林牧场。注意太空堡垒3开局建议优先布局，森林牧场开局如果对面不给节奏也尽量布局。如果有大表哥在天宫、游乐场可以斟酌使用。**（3）**{加大火力}+{捕鼠夹}用于针对没有奶酪位的阵容。前期快速击倒一个老鼠，快速布夹子在火箭下，发挥防守优势。如果老鼠救不下来就速飞一个；由于带了捕鼠夹，老鼠{舍己}救下也大概率被夹死，一般也能速飞一个。注意，若求稳则不建议使用。',
      },
    ],
    ...
    skills: [
      ...
      },
      {
        ...
        skillLevels: [
          ...
          {
            level: 2,
            description: '防狼锤命中时，使目标在一段时间内禁用技能与道具。',
            cooldown: 0.5,
            detailedDescription:
      ...
      },
      {
        ...
        skillLevels: [
          ...
          {
            level: 2,
            description: 'Hp未满时，爪刀CD缩短，且可连续挥爪三次。',
            detailedDescription:
              '当前Hp低于Hp上限时，爪刀CD缩短40%，且在连续空刀三次后才会进入空刀CD。',
          },
          {
            level: 3,
            description: 'Hp未满时，{主动技能}和{武器技能}CD缩短。',
            detailedDescription: '当前Hp低于Hp上限时，{主动技能}和{武器技能}CD缩短40%。',
          },
        ],
      },
    ],
    ...
    knowledgeCardGroups: [
      {
        cards: [
          ...
          [
            CardGroupType.Or,
            [CardGroupType.And, 'S-屈打成招', 'A-加大火力'],
            [CardGroupType.And, 'S-知识渊博', 'B-皮糙肉厚'],
          ],
        ],
        description:
          '{屈打成招}+{加大火力}用于对抗马索尔或是由多名携带幸运的老鼠组成的车队；{知识渊博}+{皮糙肉厚}用于对抗极端打架队。',
      },
      {
        cards: [
          'S-击晕',
          ...
          [
            CardGroupType.Or,
            [CardGroupType.And, 'A-熊熊燃烧', 'A-加大火力'],
            [CardGroupType.And, 'S-乘胜追击', 'C-猫是液体'],
          ],
        ],
        description:
          '{熊熊燃烧}+{加大火力}为传统双烧卡组，放飞效率极高；{乘胜追击}+{猫是液体}用于对抗减速队，其中{猫是液体}可替换为其他3费知识卡。',
      },
      {
        cards: ['A-穷追猛打', 'A-加大火力', 'B-皮糙肉厚', 'B-恐吓', 'B-反侦察', 'C-猫是液体'],
        description: '用于死守奶酪的卡组。',
      },
    ],
    ...
    skills: [
      {
        ...
        skillLevels: [
          ...
          {
            level: 3,
            description: '持续伤害频率更高。米特在“刺激”状态下获得减伤并提高绑火箭速度。',
            detailedDescription:
              '持续伤害频率提高至0.5秒/次。米特在“刺激”状态下获得30%减伤并提高绑火箭速度50%。',
            cooldown: 12,
          },
        ],
      },
        ...
        skillLevels: [
          {
            ...
            detailedDescription:
              '每次[受到伤害](实际伤害值需大于0。例：胡椒粉对自身造成伤害可以获得“野性”，但如果该伤害被固定减伤减免至0则不获得野性)获得1层“野性”状态，持续15秒，最多叠加10层。每层野性略微提升Hp恢复。使用爪刀时消耗全部野性，若[成功对目标造成伤害](不包括被护盾等状态抵挡的情况)，[额外](与原伤害分为不同的两段，后于原伤害结算，但先于知识卡结算)对其造成{0*,不受来源影响}伤害（每消耗1层野性使基础伤害提升4，上限40）。\n持有7层及以上的“野性”时，开始[对火箭交互时](绑火箭与修火箭)会获得6秒强霸体（内置CD：17秒）。',
          },
          {
            level: 2,
            description:
            ...
            detailedDescription:
              '被爪刀命中的[敌方](包括猫咪)20秒内无法回复Hp。若爪刀命中的老鼠在此效果生效期间被绑上火箭，则队友救援该老鼠的速度降低50%。',
          },
          {
            level: 3,
            description:
  ...
  塔拉: {
    ...
    skillAllocations: [
      ...
      },
      {
        ...
        pattern: '030301113',
        weaponType: 'weapon1',
        description: '二武常规加点，必要时可以五级点情谊补伤害。',
      },
    ],
    knowledgeCardGroups: [
      {
    ...
    skills: [
      {
        ...
        aliases: ['冲刺'],
        description:
          '向前冲刺，期间无敌，若命中敌方将造成少量伤害、大幅降低其移速和跳跃高度，且可在短时间内使用二段技能[挑飞](无视护盾和部分无敌效果)；若挑飞老鼠，可使用三段技能追踪到老鼠位置进行[连斩](无视护盾、霸体和无敌效果)，使老鼠减少Hp且无法移动，但可以使用技能和交互。快速点击技能键可加速连斩。被连斩的老鼠被绑上火箭时，引线将额外减少10s。',
        detailedDescription:
          '向前冲刺2s，期间无敌、移速提升75%，若命中敌方将造成{10*,可致伤}伤害、使其移速降低25%，跳跃高度降低50%，持续3s。冲刺时遇到正常、虚弱、护盾、霸体和[部分无敌效果](罗宾汉降落伞、剑杰格挡、剑菲冲刺、冰冻保鲜特技、变大)的老鼠均可解锁二段技能挑飞，否则技能进入CD。使用{绝地反击(特技)}将终止冲刺并使技能进入CD。解锁后可在6s内使用二段技能向上[挑飞](前摇0.35s，可用道具键、其他技能键取消释放；无视护盾和除罗宾汉杰瑞的降落伞、剑客泰菲的冲刺、变大外的其他无敌效果，但无法挑飞霸体老鼠)脚下的老鼠，对老鼠造成1.9s眩晕并击飞1s。若挑飞老鼠，可在6s内使用三段技能[追踪到老鼠位置](以2000速度飞向敌方，飞行最大时间0.6s，若发生以下情形将不会释放连斩：超过最大飞行时间，被打断，被墙体、拳头盒子、嫦娥阻挡，老鼠在自己下方（泰菲家族由于模型小，若与剑汤站在同一水平面则无法连斩）)进行[连斩](无视护盾、霸体和无敌效果；期间只会受到天使泰菲反伤和可击中管道中的角色的技能伤害)。连斩持续3.1秒，会使[范围内的老鼠](不包括手中的老鼠)浮空4.2秒、每0.55秒受到{10*,不受目标影响,无视护盾,不可致伤}伤害，总共5次。连斩期间老鼠无法移动，但可以使用技能和交互。无法打爆机器鼠。[快速点击可加速连斩](每次点击使连斩持续时间缩短0.5s，同时老鼠浮空时间缩短0.5s，并且总共至多额外造成两次伤害)。连斩后摇0.8s，可用道具键取消。连斩造成两次伤害后会使老鼠受到[威慑效果](绑上火箭后消失)，被绑上火箭时，引线将额外减少10s。挑飞和连斩[在空中释放](不是跳放)将直接进入CD。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        forecast: 0,
      ...
      },
      {
        ...
        detailedDescription:
          '举起剑，7.9s内[视野扩大至原来的2倍](但移除其他远视效果)，阻挡面朝方向的道具攻击。再次点击技能，可反弹前方250~750范围内飞行中的道具，无前摇，后摇0.9s，可用道具键取消。跳跃和落下将取消防御状态。若防御期间没有阻挡或反弹任何道具，则在取消时[返还一半CD](实际为CD缩短至10s/6s)。\n防御期间阻挡且可以推动老鼠(无视无敌或护盾)以及果盘等场景物。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
      ...
      },
      {
        ...
        detailedDescription:
          '点击技能，释放三段剑舞。一段旋刃突击，前摇0.3s，旋转着向前上方突进，并带走[碰到的敌方](无视敌方任何状态)；6s内可释放第二段剑刃重击（无视敌方任何状态都可触发连斩），前摇0.1s，后摇0.6s，可用道具键取消，对附近的敌方造成眩晕0.5s；6s内可释放第三段剑舞劈砍，对劈砍位置[附近](范围较小)的敌方造成{50*,不可致伤}伤害、击退和眩晕（劈砍时若不在平台或地面将不会造成效果），命中时将减少8s骑士连斩CD。技能前摇和释放期间无霸体，若[被打断](包括碎片、夹子、眩晕、其他技能键、道具、特技、爪刀等)将直接进入技能CD。\n每段分别可与骑士连斩相互衔接释放：任意技能某段命中可触发两个技能下一段；连招最后使用的技能将进入CD。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        ...
        skillLevels: [
          ...
          },
          {
            ...
            cooldown: 20,
            detailedDescription:
              '一段和三段攻击额外造成15%减速，持续3.5s；二段造成的眩晕时间延长至0.8s。一段突进时将跃起更高的高度。',
          },
          {
            level: 3,
            description: '释放第三段将提高移速一段时间。',
            cooldown: 12,
            detailedDescription: '释放第三段将获得12%加速，持续3.5s。',
          },
        ],
      },
      {
        ...
        skillLevels: [
          ...
          {
            level: 2,
            description: '剑气命中后，一段时间内移速增加、免疫碎片且不受减速影响。',
            detailedDescription:
              '剑气[命中敌方](注意：剑气不会命中“已被当次常规爪击造成伤害的目标”)且造成控制时，移速增加20%、免疫碎片且[不受减速影响](仍会正常受到减速相关状态，但免疫其中降低移速的效果)，持续9.9秒。',
          },
          {
            level: 3,
            description: '剑气命中时，重置{主动技能}CD。',
            detailedDescription:
              '剑气[命中敌方](注意：剑气不会命中“已被当次常规爪击造成伤害的目标”)且造成控制时，{主动技能}的CD缩短30秒。',
          },
        ],
      },
    ],
    ...
    skills: [
      ...
      },
      {
        ...
        skillLevels: [
          ...
          {
            level: 2,
            description: '移速和绑火箭速度提高。',
            detailedDescription: '移速提高20%，绑火箭速度提高80%。',
          },
          {
            level: 3,
            description: '攻击力和恢复速度提高。',
            detailedDescription: '额外获得15攻击力，每秒额外恢复20Hp。',
          },
        ],
      },
    ],
  ...
  凯特: {
    ...
    knowledgeCardGroups: [
      ...
      {
        cards: ['S-乾坤一掷', 'A-熊熊燃烧', 'A-穷追猛打', 'B-皮糙肉厚'],
        description: '20点卡组，乾坤一掷提供常驻移速与增伤，提高上限。',
      },
    ],
    specialSkills: [
      {
  ...
  苏蕊: {
    ...
    knowledgeCardGroups: [
      ...
      {
        id: '守株待鼠',
        description: '对战{恶魔泰菲}的卡组',
        groups: [
          {
            cards: ['S-蓄势一击', 'A-穷追猛打', 'A-越挫越勇', 'B-守株待鼠', 'B-皮糙肉厚'],
            description:
              '恶魔泰菲的二武器“小淘气”的{绿色小淘气}可对苏蕊造成高额伤害，带上这套卡后老鼠如果被绑上火箭，绿色小恶魔的伤害将降低至0',
          },
        ],
        defaultFolded: true,
      },
    ...
    skills: [
      {
        ...
        aliases: ['跳舞'],
        description:
          '苏蕊开始舞动，持续40秒。舞动开始时立刻回复Hp，放下手中老鼠并使其自主跟随。舞动期间免疫敌方老鼠的绝大部分控制，以及冰块和鞭炮的控制，爪刀变为“舞动亮相”。舞动时每13秒出现爱心提示，期间点击技能按钮将回复Hp且加速，爱心消失后开始冷却。舞动时接触虚弱老鼠将使其自主跟随苏蕊30秒，期间遇到火箭立刻绑上。\n“舞动亮相”：CD大幅增加，但伤害提高，且范围改为[以苏蕊为中心的圆形区域](半径相比普通爪刀的攻击距离有所增加)。{苍蝇拍}范围和效果也随之改变。',
        detailedDescription:
          '苏蕊开始舞动，持续40秒。舞动开始时立刻回复50Hp，若手中有老鼠，则放下老鼠并使其自主跟随30秒。舞动期间进入{跳舞免控}，爪刀变为“舞动亮相”。舞动时每13秒出现爱心提示，持续3秒，[提示期间点击技能按钮](类似技能，处于交互、被控制等状态时无法点击；若提示期间未及时点击按钮则爱心提示破碎，不会获得增益效果)将回复30Hp、加速10%。爱心消失后开始冷却。舞动时接触虚弱老鼠（被{打开的老鼠夹}夹住的老鼠除外）或[刚被击倒的老鼠](包括刚进入知识卡铁血、表演者•杰瑞一级被动、佩克斯三级被动状态的老鼠)，将使其自主跟随30秒，在此状态下老鼠[不受控制地跟随苏蕊](若老鼠身上有反向效果，则在跟随时会朝远离苏蕊的方向移动，这可能导致苏蕊难以将老鼠拉上平地的火箭)，期间解除并免疫虚弱、禁用技能与道具、无法自主移动和交互、[无法对技能加点](对技能加点后会短暂生效，之后恢复到原本的加点)、移速增加，但仍能受到伤害和[部分来自猫方控制效果](不包含冰块、鞭炮、老鼠夹造成的控制)，且遇到火箭会[立刻绑上](会触发绑火箭-10秒的机制)。老鼠跟随期间与苏蕊距离较远时，会立即传送到苏蕊身边；但若[老鼠与苏蕊距离极远](通常仅在苏蕊因其它效果而传送时才会出现此情况，例如钻管道)，则老鼠会提前解除跟随。\n“舞动亮相”：与爪刀类似，但[CD改为{:specialClawKnifeCdUnhit}秒（未命中）和{:specialClawKnifeCdHit}秒（命中）](未命中CD本质上是命中CD返还一定百分比后的结果，对于苏蕊来说是返还50%；无视其他改变CD的效果（包括变身饮料改变基础CD的效果，及乘胜追击等百分比减少CD的效果）)，伤害变为{50*,可致伤}，范围改为[以苏蕊为中心的圆形区域](半径相比普通爪刀的攻击距离有所增加)，且{长爪}失效；如果携带了{乘胜追击}和{蓄势一击}且[造成了蓄势一击的伤害效果](若敌方受到蓄势伤害/亮相攻击伤害后就进入了虚弱状态，则不算作造成效果)，则会[在原本的基础上额外叠加一层乘胜效果](即使爪刀命中多名老鼠，也只会额外叠加一层)。{苍蝇拍}范围也随之改变，且直接抓起时的效果改为[使老鼠立刻自主跟随](包括触发三级被动后灵体状态的表演者•杰瑞)。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        cancelableAftercast: '无后摇',
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '扔出{瑜伽球(衍生物)}，落地后沿指定方向滑动。再次使用技能使其膨胀，膨胀的瞬间对周围的敌方造成少量伤害和短暂{眩晕}，并弹飞对方。',
        detailedDescription:
          '扔出{瑜伽球(衍生物)}，同时技能进入读条；瑜伽球落地后沿指定方向滑动，期间苏蕊可再次点击技能键使其膨胀，膨胀的瞬间对周围的敌方造成[少量伤害和一定时间](与技能等级有关)的{眩晕}，[眩晕期间对方会被弹飞](弹飞距离取决于眩晕时间)。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        ...
        skillLevels: [
          {
            level: 1,
            description: '',
            detailedDescription: '瑜伽球的伤害为{50*,不受来源影响,可致伤}、造成的眩晕持续1.5秒。',
            cooldown: 20,
            charges: 2,
          },
          {
          ...
          {
            level: 3,
            description: '瑜伽球造成的眩晕持续时间延长。',
            detailedDescription:
              '瑜伽球造成的眩晕持续时间延长至2.5秒、伤害提高至{55*,不受来源影响,可致伤}。',
            cooldown: 15,
            charges: 2,
          },
        ],
      },
      {
        ...
        skillLevels: [
          ...
          {
            level: 2,
            description: '虚弱时间缩短至2秒。',
            detailedDescription:
              '[虚弱时间缩短至2秒](但通常起身时只有100Hp。这是因为虚弱本质上会附带高额Hp恢复，该恢复时间被缩短了)。',
          },
          {
            level: 3,
            description:
    ...
    skills: [
      {
        ...
        aliases: [],
        description:
          '开始{飞行}，期间爪刀CD缩短、并附带眩晕。\n在飞行时对虚弱的老鼠再次释放，可以吸引距离最近的一个火箭并将该老鼠直接绑到火箭上，同时提高燃烧速度25%。\n飞行过程中无法将老鼠抓到手中，当手中有老鼠时，飞行会导致老鼠掉落。',
        detailedDescription:
          '开始{飞行}，期间{完全失重}，水平方向基础速度变为1310/秒，竖直方向为600/秒，强制切换到摇杆操作，可以穿过部分平台，[爪刀CD更改](同类状态只能生效一个，因此该状态会被“变身饮料”效果覆盖)为2秒(未命中)/4秒(命中)、并附带1.1秒{眩晕}。\n飞行期间技能同步进入读条，可在身边有{虚弱}老鼠时再次使用技能，吸引以天使汤姆为中心、半径4350范围内最靠近的一个火箭到该老鼠位置，并将其直接绑到火箭上，使当次火箭燃烧速度提高25%，但没有绑老鼠减10秒的效果。（吸取动作前摇0.45秒，后摇0.45秒，可保持移动，可被转向打断，无法使用技能与道具；无法在周围没有[合适目标](包括虚弱老鼠或可吸取的火箭，其中缺少火箭会提示“范围内没有可吸取的火箭”)时释放；[可对正在钻管道的老鼠释放](火箭将生成在老鼠钻管道前消失的位置)；若前摇结束后范围内已没有虚弱老鼠则无效）\n飞行期间可以看到所有火箭位置，且靠近虚弱老鼠时会在小地图上出现特殊UI，用于指示可吸取火箭的范围。\n飞行过程中无法将老鼠抓到手中，当手中有老鼠时，飞行会导致老鼠掉落。',
        canMoveWhileUsing: true,
        canUseInAir: true,
    ...
    skills: [
      {
        ...
        detailedDescription:
          '常规：向前方连续挥爪3次，前摇分别为0.3、0.4、0.6秒，每次命中敌方均造成[一定伤害](与技能等级有关)，范围均为300。（无法在空中释放；技能期间无法移动、跳跃、交互、使用道具或其它技能）\n疾冲状态下或{武器技能}飞行中：[以1560的速度](在武器技能飞行期间释放时，自身被牵引速度不变)向前穿刺0.45秒，命中敌方造成{40*,不可致伤}伤害和1.8秒{眩晕}，穿刺期间免疫控制。（可以在空中释放；技能期间无法转向、跳跃、交互、使用道具或其它技能；技能判定范围较大，可以隔门造成伤害）',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableAftercast: '无后摇',
        canHitInPipe: true,
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            cooldown: 20,
            detailedDescription:
              '飞行结束后8秒内，进入疾冲状态所需的奔跑时间缩短至30%、所需的速度降低至基础移速的75%。',
          },
          {
            level: 3,
            description: '飞行期间每对一个敌人造成控制，减少20秒本技能CD。',
            cooldown: 20,
            detailedDescription: '飞行期间伤害每对一个敌人造成控制，减少20秒本技能CD。',
          },
        ],
        forecast: 0.45,
      },
      {
        ...
        detailedDescription:
          '斯飞能进入“疾冲”姿态，该姿态下获得“迅捷”状态。\n“疾冲”姿态： 触碰到老鼠时对其造成{10*,电击,不受来源影响,不可致伤}伤害和0.7秒{电击}眩晕（对{电免疫}期间的目标照常造成伤害和电击，但不触发{感电}），同目标10秒内不会重复触发；爪刀强化为以2000速度向前扑击0.15秒；{主动技能}变为穿刺攻击。使用爪刀、施放技能或移速降到[一定阈值](约为正常疾冲速度75%)以下0.5秒后将退出疾冲姿态。\n“迅捷”状态：获得加速，无视{碎片}、[部分](包括魔术师的黄牌，拿坡里的足球，玛丽的扇子与反向；不包括侦探泰菲的两种分身){反向}及{失明}状态、烫伤、{感电}、{打开的老鼠夹}。（获得迅捷状态不会同时清除身上负面状态）',
        skillLevels: [
          {
            level: 1,
            description:
  ...
  恶魔汤姆: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '[在自身650范围内选取一个位置](点按技能键为自身位置，拖动技能键则为指定位置；实际释放位置会根据前摇后自身的位置发生相对变化)生成{轨道}，轨道需0.9秒完全生成，会向恶魔汤姆面朝方向伸展，角度在水平、水平偏斜上/斜下27°三者内随机；轨道开始生成的第0.3秒时召唤{列车}，沿轨道进行持续0.95秒的冲撞，对被撞击的敌方造成{30*,不受来源影响,不可致伤}伤害、1秒{眩晕}及[小幅度](具体距离取决于眩晕时间，方向取决于列车撞击方向){击退}，同一目标在眩晕期间不会重复被命中、短时间内被列车命中两次后额外获得使受到的伤害提高70的{易伤}状态，持续8秒（持续期间不会再次获得，对当次伤害不生效）。\n“列车狂欢”期间，本技能会一次性召唤2条角度不相同的轨道&列车。\n技能动作不会被跳跃中断；期间可以使用爪刀攻击；可以拾取道具/饮用饮料但会使技能失效（仍执行完整技能动作，不消耗储存次数）。\n\n列车的贴图长度约1200，但实际伤害判定范围略小于贴图范围；列车的实际有效冲击范围约为从技能释放处始，向两侧各延伸3000；轨道的贴图中点与技能释放位置并不重合；列车贴图相较于轨道贴图偏上，且冲撞起始端会超出轨道贴图一段距离。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        forecast: 0.6,
        ...
        skillLevels: [
          ...
          {
            level: 2,
            description: '释放列车后短暂获得一层{护盾}。列车经过恶魔汤姆时刷新该护盾。',
            detailedDescription:
              '释放列车后获得一层{护盾}，持续2.5秒。列车经过恶魔汤姆时刷新该护盾。',
            cooldown: 8,
            charges: 3,
          },
          {
  ...
  兔八哥: {
    ...
    knowledgeCardGroups: [
      ...
      {
        cards: ['S-击晕', 'A-加大火力', 'B-攻其不备', 'C-春风得意', 'C-猫是液体'],
        description: '森林牧场卡组。',
      },
      {
        cards: ['S-击晕', 'A-熊熊燃烧', 'S-乘胜追击'],
        description: '御门酒店卡组。',
      },
      {
        cards: [
          'S-击晕',
          'A-熊熊燃烧',
          [CardGroupType.Or, 'A-加大火力', 'A-心灵手巧'],
          'A-穷追猛打',
        ],
        description: '通用卡组，除特定地图都能打。',
      },
      {
        cards: ['S-乘胜追击', 'A-熊熊燃烧', 'A-加大火力', 'A-穷追猛打'],
        description: '古堡三卡组。',
      },
      {
        cards: [
          'S-击晕',
          [CardGroupType.Or, 'S-屈打成招', 'S-知识渊博'],
          'A-熊熊燃烧',
          'C-猫是液体',
        ],
        description: '',
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            level: 2,
            description:
              '每隔一段时间，兔八哥[完全闪避](使该投掷物接触自身碰撞箱时视作未接触，继续进行飞行；离开自身碰撞箱后恢复正常判定)下一次[投掷攻击](不免疫知识卡和技能附带异常状态)。闪避成功获得一层“胜利”状态。',
            detailedDescription:
              '每隔12秒，兔八哥[完全闪避](使该投掷物接触自身碰撞箱时视作未接触，继续进行飞行；离开自身碰撞箱后恢复正常判定)下一次[投掷攻击](不免疫知识卡和技能附带异常状态)。闪避成功获得一层“胜利”状态，闪避不会打断交互，自身眩晕时也可触发闪避效果。\n能闪避的道具：除{电风扇}/{小鞭炮}/{鞭炮束}外的所有投掷道具；{果子}、{子弹}，{激光}，{鸟哨鞭炮}，{金币(衍生物)}，{火箭炮}，{红色卡牌}，{黄色卡牌}，{蓝色卡牌}，{战矛}，{小电球}、{大电球}、{电池}，{乾坤袋-投射物(衍生物)}，{定身符}、{金币符}，{蓝图-投射物(衍生物)}。\n通常误认为能闪避实则不能的道具：{长枪}，{弓箭}/{蓄力箭}，{闪耀足球}，{剑气}，{星星}。',
          },
          {
            level: 3,
            description:
    ...
    skills: [
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            cooldown: 5,
            detailedDescription:
              '点击/蓄力0.5～1.0秒/蓄力1秒以上，伤害提升至{35*,固定,不可致伤}/{40*,固定,不可致伤}/{45*,固定,不可致伤}，{眩晕}时间延长至0.8/0.9/1.1秒',
          },
        ],
      ...
      },
      {
        ...
        skillLevels: [
          ...
          {
            level: 3,
            description: '[走地状态下](不处于空中时)，飞行时间的累积速度提升；最大飞行时间延长。',
            detailedDescription:
              '[走地状态下](不处于空中时)，每秒增加1.5秒飞行时间，最多储存15秒。',
          },
        ],
        description:
          'Lv.0: [走地状态下](不处于空中时，即不包括处于跳跃，坠落等状态中)，逐渐累积飞行时间。未处于飞行状态时爪刀CD缩短。飞行状态下视野增大，可托起其他角色，并提高移速。飞行时[免疫控制](同时不会被米可采访锁定；不免疫虚弱)，但无法拾取道具、使用商店或进行交互（抓起老鼠除外）；受到伤害会减少飞行时间。飞行状态可随时退出，但会清空剩余飞行时间。飞行被[强制打断](如被变形、被打死)会暂时禁用{主动技能}。',
        detailedDescription:
          'Lv.0: [走地状态下](不处于空中时，即不包括处于跳跃，坠落等状态中)，每秒获得1秒飞行时间，最多储存10秒。未处于飞行状态时爪刀CD缩短35%；飞行状态下[视野范围增加55%](覆盖其他大部分远视效果，但可以和天宫-香炉远视效果叠加)，[可托起鼠单位](机器鼠、乾坤袋除外)，无视小平台阻挡，并提高移速至水平1015、竖直840。悬停时角色会自动向前以水平350、竖直30的速度下落。飞行时[免疫控制](不免疫虚弱)，但无法拾取道具、使用商店或进行交互（抓起老鼠除外）；受到伤害会减少2秒飞行时间。飞行状态可随时退出，但会清空剩余飞行时间。“退出飞行状态”这一操作无cd。飞行被[强制打断](如被变形、被打死)会使{主动技能}进入10秒CD。该CD不可通过吃蛋糕回复。',
        videoUrl: 'https://b23.tv/LoKzcZf',
      },
    ],
  ...
  如玉: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '如玉无法释放常规爪刀，但拥有两种特殊爪刀，特殊爪刀可在手中有老鼠时释放，[无法触发常规爪刀效果](无法直接抓起被拍子控制的老鼠，无法破坏莱恩-蘸水笔创造的方块)，[不受爪刀相关效果影响](无法受到知识卡-击晕、猛攻、蓄势一击、长爪；特技-全垒打，长爪一击，勇气爪刀影响，无法为知识卡-乘胜追击叠加层数；不受缴械及其它禁用爪刀效果影响)，[CD计算规则与爪刀相同](可被影响爪刀CD的效果影响，如变身药水及特技-“我生气了！”)，且[不会被封锁](既不会被“禁用爪刀”相关状态禁用，也不会被“禁用技能”相关状态禁用)；可打断{主动技能}；[两种特殊爪刀共用CD](共用爪刀CD，释放跳跃劈枪时会重置前刺回马枪的状态)。\n\n1.前刺回马枪：[在地面时可释放](可利用“跳放”技巧进行空中释放，详见机制相关文章)，分为2段：\n前刺枪（[前摇0.35秒，后摇0.1秒](可移动释放，不可空中释放，可被道具键取消前后摇（取消前摇会直接进入CD）)）：对身前约450范围内的敌方造成{35*,可致伤}伤害，命中非虚弱敌方时获得30%加速，持续3秒；\n回马枪（[前摇0.35秒，后摇0.35秒](可移动释放，不可空中释放，可被道具键取消前后摇（取消前摇会直接进入CD）)）：对身后约450范围内的敌方造成{35*,可致伤}伤害，并{击退}对方约100距离，若命中[被前刺枪命中过的目标](指被同一轮前刺回马枪的第一段命中过的目标，包括初次命中时处于虚弱状态的目标，或是再次命中时持有护盾的目标，但不包括再次命中时已虚弱的目标)，则[额外](与原伤害分为不同的两段，且后于原伤害结算)造成{100*,可致伤}伤害和0.5秒{眩晕}（[与常规眩晕略有区别](该状态实际效果与眩晕类似，但角色头顶并未出现“眩晕”图标；动作与击退类似，但击退距离为0，且会中断回马枪原本的击退效果)），且不再造成{击退}。\n\n2.跳跃劈枪（[前摇0.1秒，后摇0.45秒](可移动释放，可被移动、跳跃、道具键取消前后摇（取消前摇会直接进入CD）)）：在空中时可释放，对身前[约500范围内](500指横向判定范围。该攻击的纵向判定范围远大于常规爪刀)的敌方造成{35*,可致伤}伤害，命中非虚弱敌方时获得30%加速，持续3秒。跳跃劈枪有概率出现丢伤害bug（出现命中判定但不造成伤害），[触发条件暂不明确](根据目前的触发情况来看，可能与“过快地取消后摇”和/或“目标与如玉距离过远”有关)。\n\n如玉变为粉笔猫/大星星后释放常规爪刀，且该常规爪刀也不受缴械影响。',
        skillLevels: [
          {
            level: 1,
            description:
            ...
            detailedDescription:
              '[因其他原因虚弱时](即：不因本技能提供的“坚毅”导致虚弱时)[改为进入10秒“坚毅”状态](仍会触发以虚弱为判定条件的效果，如鼠方的击倒敌方获得金钱效果及终结赏金，和知识卡-越挫越勇，暴怒，乘胜追击（失去层数）等)：立即解除控制并回复100Hp、移速提高15%、免疫{眩晕}和{猫虚弱}，期间对任意敌方造成虚弱则提前解除该状态。“坚毅”状态正常结束时，如玉进入{猫虚弱}。',
          },
          {
            level: 2,
            description:
              '[击倒如玉](包括通过攻击使如玉Hp恰好为零，但未进入“坚毅”状态的情况)的敌方在30秒内无法对如玉造成{眩晕}和{猫虚弱}。如玉在{眩晕}期间受到敌方攻击可触发“花枪反击”。',
            detailedDescription:
          ...
          },
          {
            level: 3,
            description:
              '“坚毅”会回复更多Hp，且对敌方造成{眩晕}即可解除。{2级被动}效果的持续时间延长为60秒。',
            detailedDescription:
              '“坚毅”改为回复200Hp，且对敌方造成{眩晕}即可解除。{2级被动}效果的持续时间延长为60秒。',
          },
        ],
      },
    ],
  ...
  侦探汤姆: {
    ...
    knowledgeCardGroups: [
      ...
      {
        cards: ['S-蓄势一击', 'S-乾坤一掷', 'A-心灵手巧', 'A-穷追猛打'],
        description:
          '蓄势一击和乾坤一掷用来补伤害，心灵手巧提高绑火箭速度，穷追猛打用来起第一波节奏。',
      },
      {
        cards: ['S-乘胜追击', 'B-恐吓', 'A-穷追猛打', 'C-猫是液体', 'B-攻其不备'],
        description:
          '乘胜穷追和攻其不备可以快速跑图，打死一只老鼠之后利用穷追猛打去别处拾取线索的同时利用恐吓控住奶酪进度，可以使前期获得相当可观的线索数量。',
      },
    ],
    specialSkills: [
      {
        name: '蓄力重击',
        description: '侦探汤姆缺伤害，蓄力重击可补充伤害。',
      },
      {
        name: '我生气了！',
        description: '侦探汤姆依赖爪刀造成伤害，{我生气了！}能提高容错。',
      },
      {
        name: '全垒打',
    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '选择一只敌方老鼠进行锁定。锁定期间：在小地图上展示该老鼠的位置；其移动时会留下踪迹，自身接触踪迹会获得加速；自身对非锁定的老鼠造成的伤害降低，受到非被锁定目标对自身造成的伤害和{眩晕}大幅降低。',
        detailedDescription:
          '侦探汤姆通过外置轮盘[选择一只敌方老鼠](被{绑上火箭}或{放飞}的老鼠除外)进行锁定，对目标赋予“被锁定”状态，移除其护盾和部分变身效果，并对自身赋予“锁定”状态，持续一段时间。\n\n“锁定”：侦探汤姆对非“被锁定”目标造成的伤害变为原先的0.6倍；非“被锁定”目标对侦探汤姆造成的伤害和{眩晕}状态时长变为原先的0.2倍。\n“被锁定”：持续在敌方小地图上显示位置；每移动约100距离，会生成1片“踪迹”。\n“踪迹”：[侦探汤姆](包括侦探汤姆的队友)接触后{移速}×1.2，重复触碰仅刷新持续时间；场上最多同时存在25片“踪迹”，超出上限后最先生成的“踪迹”会消失；“锁定”与“被锁定”状态结束时，所有“踪迹”统一消失。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: ['跳跃键', '道具键'],
        cancelableAftercast: ['移动键', '跳跃键', '道具键'], // TODO: 一说无后摇
        cooldownTiming: '释放时',
        cueRange: '随距离远近变化',
        forecast: 1,
        skillLevels: [
          {
            level: 1,
            description: '“锁定”持续7秒。',
            detailedDescription: '“锁定”与“被锁定”持续7秒。',
            cooldown: 10,
          },
          {
            level: 2,
            description: '“锁定”的持续时间延长至10秒。',
            detailedDescription: '“锁定”与“被锁定”的持续时间延长至10秒。',
            cooldown: 10,
          },
          {
            level: 3,
            description: '“锁定”期间，增加自身爪刀攻击范围。',
            detailedDescription: '“锁定”期间，增加30%自身爪刀攻击范围。',
            cooldown: 10,
          },
        ],
      },
      {
        ...
        aliases: ['放大镜'],
        description:
          '举起放大镜释放射线照射敌方，射线[每0.3秒对敌方叠加一层“$被照射$text-orange-500#”状态](会被{隐身}状态免疫)，使其减速，叠满6层后转化为“被看穿”状态，使敌方反向、禁用技能与道具、受到的伤害增加、[体型变大](对于受击范围来说，仅纵向变大，横向不变)。侦探汤姆对该敌方造成伤害后6秒内自身爪刀CD减半、[免疫禁用爪刀效果](包括知识卡-{缴械}、天使杰瑞-{神之惩戒}、玛丽-{贵族礼仪})。',
        detailedDescription:
          '长按并拖动技能键，持续[释放一道射线照射指定位置](有最远距离限制，范围为圆形；\n射线会被天花板、{墙壁}、{地面}阻挡)，[当照射的位置有目标时视为命中目标](除非目标隐身)。射线每0.3秒对命中的目标施加1层“被照射”状态；松开技能键结束释放；若技能释放后1.9秒内[主动](因受控制而被动取消时，无减免CD效果)取消，则下一次使用CD变为1秒；放大镜可使用两次时，1.9秒内连续点击两次会导致可使用次数被吞掉一次；若持续长按不取消，则技能最长持续20秒；手中有老鼠时无法使用。\n技能释放期间，侦探汤姆可照常移动、跳跃、使用爪刀或主动技能，且以上行为不会中断技能；[但无法拾取或使用道具](若此时点击或拖动道具键，则射线照射的位置不再随技能键的拖动而移动)。\n\n“被照射”：可叠加，4秒内未继续叠加时清空层数，最高可叠加6层；减少5%移速与2%跳跃高度，减速与减跳效果各自不可叠加。叠加至6层后，目标失去“被照射”状态，并获得“被看穿”状态与持续6秒的{反向}状态。\n\n“被看穿”：持续6秒；禁用技能与道具；受到的伤害提高；免疫“被照射”状态；被猫抓住时，使抓住自身的猫绑火箭速度×2，持续10秒；[自身体型变大](仅纵向变大，横向不变)。\n侦探汤姆对“被看穿”的敌方造成伤害后，自身爪刀CD减半，且[免疫禁用爪刀效果](包括知识卡-{缴械}、天使杰瑞-{神之惩戒}、玛丽-{贵族礼仪})，持续6秒\n\n“被照射”与“被看穿”均无视{无敌}、{护盾}、{霸体}状态，但{无敌}、{护盾}状态不会受到减速效果影响；两种状态不会同时存在于同一目标。处于{鼠虚弱}状态中的老鼠不会被添加“被看穿”状态。\n\n手动拖动放大镜射线命中敌方后（无论是否成功施加“被照射”），将触发“光线自动锁定”；当拖动技能按键角度超过240°或目标离开范围时，将退出“光线自动锁定”。\n侦探汤姆对处于“被锁定”状态的目标使用放大镜射线时，若目标位于技能最大范围略小范围内，则会触发“联动自动锁定”；“联动自动锁定”状态下无法通过拖动角度取消，仅能通过目标离开范围解除。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        forecast: 0,
        aftercast: 0,
        ...
        skillLevels: [
          {
            level: 1,
            description: '处于“被看穿”状态下的目标受到的来自侦探汤姆的伤害增加{30,固定}',
            detailedDescription:
              'CD为10秒。处于“被看穿”状态下的目标每次受到来自侦探汤姆的伤害时，额外受到{30,固定}',
            cooldown: 10,
            charges: 2,
          },
          {
            level: 2,
            description: '处于“被看穿”状态下的目标受到的来自侦探汤姆的伤害增加{50,固定}',
            detailedDescription:
              '处于“被看穿”状态下的目标每次受到来自侦探汤姆的伤害时，额外受到{50,固定}',
            cooldown: 10,
            charges: 2,
          },
          {
      ...
      },
      {
        ...
        type: 'passive',
        description:
          '自身虚弱时间大幅降低，但起身后会坐上轮椅，期间仅可移动和跳跃（本效果无需升级被动即会生效）。\n本技能升级后，敌方进行部分行为时会掉落{线索}。侦探汤姆可以拾取线索并逐步强化自身，每收集10线索$依次$font-bold#获得以下能力：⒈可主动坐上轮椅，快速移动并获得{隐身（状态）}；⒉受击会[获得{隐身（状态）}效果](使用道具或进行任意交互后会显形)；⒊[受击获得的隐身效果强化](不再会因为使用道具或进行任意交互而显形)；⒋每15秒获得全局透视；⒌将「已被绑上火箭至少一次的老鼠」绑上火箭时，直接放飞该老鼠。\n线索值上限为50点。进入墙缝期后，失去一半的线索值。',
        detailedDescription:
          '进入{猫虚弱}状态时，2秒后将自动起身，并获得“侦探汤姆虚弱状态”：持续5秒；{无敌}；可进行移动与跳跃；无法进行交互、捡起道具、使用爪刀、使用主动技能或特技。（本效果无需升级被动即会生效）\n\n侦探汤姆拥有“线索值”机制。本技能升级后，敌方进行部分行为时会掉落{线索}。\n“线索”：侦探汤姆靠近后自动拾取，并增加自身“线索值”；场上最多同时存在14个“线索”，超出上限后最先生成的“线索”消失。\n“线索值”仅可通过拾取“线索”增加，上限为50点；进入墙缝期后，自身当前“线索值”减少一半。\n达到不同“线索值”时，将获得额外能力：\n$达到10点$text-blue-700 font-bold#：获得技能“轮椅”，CD为6.5秒。释放后进入持续3秒的“轮椅状态”，期间移速增加35%，跳跃能力提高40%，并获得持续2秒的{隐身}；释放后每秒恢复10Hp，持续10秒。\n$达到20点$text-blue-700 font-bold#：健康值降低时，进入“侦探汤姆隐身”：{隐身}，持续4秒，使用道具或进行任意交互后显形。\n$达到30点$text-blue-700 font-bold#：“侦探汤姆隐身”不再会因为使用道具或进行任意交互而显形；隐身期间移速不会低于正常移速；爪刀CD缩短50%。\n$达到40点$text-blue-700 font-bold#：每15秒对自身施加“发现”状态，并对敌方施加“被发现”状态。“发现”：显示敌方在地图上的位置，无视部分[隐藏小地图效果](如侦探杰瑞Lv.2被动、机器鼠状态)，持续3秒，会被{降落伞}免疫。“被发现”：无实际效果，仅对鼠方提示。\n$达到50点$text-blue-700 font-bold#：侦探汤姆在同一局内第2次及以上绑上同一只敌方老鼠时，[直接放飞该老鼠](实际效果为使绑有这只老鼠的火箭引线时间缩短1000秒)。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        skillLevels: [
          {
            level: 1,
            description:
              '敌方老鼠喝药水、拾取道具、推奶酪、救援队友、造成或受到伤害时，会生成“线索”。',
            detailedDescription:
              '敌方老鼠喝药水、拾取道具、推奶酪、救援队友时，或侦探汤姆对敌方造成伤害、受到敌方伤害时，将在目标附近约150范围内生成“线索”；敌方进行推奶酪或救援队友成功时，额外生成1个“线索”。不同行为间掉落的线索不会互相顶替消失。',
          },
          {
            level: 2,
            description: '被{侦探锁定}锁定的目标每次掉落“线索”时，额外生成1个“线索”。',
          },
          {
            level: 3,
            description: '自身虚弱后坐上轮椅期间移速提高20%。',
            detailedDescription: '自身虚弱后进入的“侦探汤姆虚弱状态”期间移速提高20%。',
          },
        ],
      },
    ],
