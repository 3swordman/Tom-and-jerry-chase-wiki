...
const mouseAchievementDefinitions: Record<string, AchievementDefinition> = {
  鼠皇: { score: 400, description: '击中猫10次', aliases: ['鼠黄', '老鼠英雄'] },
  鼠圣: { score: 400, description: '火箭上救下队友5次及以上', aliases: ['救世之翼', '五连救援'] },
  机智: { score: 200, description: '获得胜利或成功逃脱' },
  翻盘: { score: 200, description: '老鼠剩余2只进入逃脱期并最终逃跑' },
  可靠: {
    score: 200,
    description: '火箭上救队友3次',
    aliases: ['救援高手', '救援大师', '三连救援'],
  },
  贪吃: { score: 200, description: '参与塞入3个奶酪', aliases: ['奶酪高手', '奶酪大师'] },
