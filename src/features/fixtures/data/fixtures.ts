...
const FixtureDefinitions: Record<string, FixtureDefinition> = {
  ...
  斜面: {
    ...
    description:
      '斜向平台是具有一定角度的{平台}（或{地面}或{墙壁}），所承载的物体会因重力而向下移动，除此之外与平台/地面/墙壁的特性相同。',
  },
  弹性平台: {
    type: '平台类',
    source: '通用组件',
    ...
    detailedDescription:
      '弹性平台是具有“弹性”的{平台}，会反弹[正常落在其上方的物体](此处特指本身不具有弹性的物体。弹性平台不会使本身具有弹性的物体弹得更高)，反弹幅度取决于物体接触弹性平台时的速度。此外角色接触弹性平台后的下一次跳跃速度会[大幅提高](正常情况下，弹性平台会让角色跳跃初速度直接到达上限（2000/秒），对应跳跃高度约为660)并发出“弹簧”的音效，该跳跃增强buff在进行一次跳跃或结束滞空时消失。\n除此之外，弹性平台与平台的特性相同。（游戏中暂不存在属于“地面”或“墙壁”类型的弹性平台，但存在斜向的弹性平台，与此相关的部分特性内容可参考{斜面}）',
  },
  移动平台: {
    type: '平台类',
    source: '通用组件',
    ...
    description:
      '移动平台是会沿预定轨迹来回移动的{平台}，且会使[被自身直接承载的物体](即不包括通过其它物体而间接被自身承载的物体)与自身一同移动，除此之外与平台的特性相同。（除电梯外，游戏中暂不存在其它属于“地面”或“墙壁”类型的移动平台）',
  },
  传送带: {
    type: '平台类',
    source: '通用组件',
  ...
  道具销毁口: {
    ...
    detailedDescription:
      '指定范围内的道具处于道具销毁口一段时间后将被销毁。\n\n以下为可销毁道具列表：{盘子}、{扁盘}、{玻璃杯}、{碗}、{香水瓶}、{胡椒瓶}、{番茄}、{冰块}、{灰花瓶}、{蓝花瓶}、{小鞭炮}、{鞭炮束}、{高尔夫球}、{叉子}、{老鼠夹}、{苍蝇拍}、{遥控器}、{玩具枪}、{修理锤}、{黄金修理锤}、{牛奶}、{蛋糕}、{远视饮料}、{隐身饮料}、{兴奋饮料}、{护盾饮料}、{变身饮料}、{神秘饮料}、{狗骨头}、{电池}。\n在{疯狂奶酪赛}中，道具销毁口的销毁等待时间延长，但会销毁{奶酪}。',
  },
  国王: {
    type: ['平台类', '组件类', 'NPC'],
    source: '地图组件',
  ...
  活板门: {
    ...
    detailedDescription:
      '角色可通过与活板门左侧开关进行交互，打开/关闭活板门，该交互有5秒内置CD，且打开活板门有动作前/后摇（后摇可被跳跃键消除）。\n活板门处于关闭状态时可看作是上层的{地面}，同时会在活板门通道的下方生成下层的天花板（有阻挡作用但无实际贴图）。极少数情况下，角色或部分物件有机会卡入上层地面与下层天花板之间的缝隙中。',
  },
  上锁的门: {
    type: ['组件类', '可交互'],
    source: '地图组件',
  ...
  大钟: {
    ...
    supportedMaps: ['雪夜古堡I', '雪夜古堡II', '雪夜古堡III'],
    description:
      '角色可通过交互拉响巨钟（有内置CD），使处于部分房间内的我方角色获得{加速}（猫）/{跳跃高度提升}（鼠），敌方角色受到{硬直}或{眩晕}（不掉落道具），并唤醒{国王}。',
    detailedDescription:
      '角色可通过交互拉响巨钟（有内置CD），使处于部分房间（包括钟楼、侍卫房、走廊、盔甲房、楼梯间、庭院）的我方角色获得{加速}（猫）/{跳跃高度提升}（鼠），处于上述房间的敌方角色则随机受到{硬直}或{眩晕}（不会使角色掉落手中道具）；钟声会唤醒{国王}（若国王处于唤醒CD期间则除外）。',
  },
  雪地密道: {
    type: ['地面类'],
    source: '地图组件',
  ...
  驾驶舵: {
    ...
    detailedDescription:
      '驾驶舵的八个把手平时都可被当做是{平台}。当{控制阀}被任意角色交互时，驾驶舵进入短暂旋转状态，期间把手平台短暂[消失](不再阻挡角色和道具，但外观贴图无变化)且使碰触舵盘的角色进入短暂{眩晕}（不会使角色掉落手中道具）。',
  },
  喷气口: {
    type: ['组件类'],
    source: '地图组件',
  ...
  仪表盘开关: {
    type: ['组件类', '可交互'],
    source: '地图组件',
    aliases: ['仪表盘按钮', '彩蛋房开关', '彩蛋房按钮', '红绿按钮', '仪表盘'],
    move: false,
    gravity: false,
    supportedMaps: ['夏日游轮I', '夏日游轮II', '夏日游轮III'],
    description:
  ...
  工具箱: {
    ...
    detailedDescription:
      '角色可通过交互打开工具箱，随机生成一个道具。工具箱将保持被打开状态一段时间（该状态持续60秒），随后重新合上。工具箱的上方可被当做{平台}。工具箱被打开后将生成以下道具：{小鞭炮}、{冰块}、{灰花瓶}、{蓝白大花瓶}、{玩具枪}、{随机饮料}，具体概率暂时不明。',
  },
  '道具生成口-奶酪矿': {
    type: ['组件类'],
    source: '地图组件',
    aliases: ['奶酪矿', '道具生成口-太空堡垒'],
    move: false,
    gravity: false,
    supportedMaps: ['太空堡垒I', '太空堡垒II', '太空堡垒III'],
    description:
  ...
  吧台: {
    ...
    description:
      '吧台位于休闲舱，其上方初始会刷新7个呈梯形摆放的{玻璃杯}。当有玻璃杯被放在距吧台上方一定距离（略高于2个玻璃杯）的位置时，在短暂延迟后该玻璃杯将被销毁，并原地生成一瓶{神秘饮料}，可无限次兑换，但每次生成有180秒的CD。',
    specialImageUrl: '/images/maps/%E5%A4%AA%E7%A9%BA%E5%A0%A1%E5%9E%92.png',
  },
  休闲舱开关: {
    type: ['组件类', '可交互'],
  ...
  货物: {
    ...
    supportedMaps: ['太空堡垒I', '太空堡垒II', '太空堡垒III'],
    description:
      '会在货舱被{货物生成口}不断生成，经传送带传送到末端后销毁。货物上端可以阻挡和承载物体。',
  },
  游乐场水池: {
    type: ['平台类', '组件类'],
    source: '地图组件',
  ...
  鸭爸爸: {
    type: 'NPC',
    source: '地图组件',
    aliases: ['大鸭子', '森林牧场鸭子', '森林牧场大鸭子', '公鸭', '公鸭子'],
    move: true,
    gravity: true,
    supportedMaps: ['森林牧场'],
    description:
  ...
  鸭妈妈: {
    type: 'NPC',
    source: '地图组件',
    aliases: ['大鸭子', '森林牧场鸭子', '森林牧场大鸭子', '母鸭', '母鸭子'],
    move: true,
    gravity: true,
    supportedMaps: ['森林牧场'],
    description:
  ...
  树丛: {
    ...
    gravity: false,
    supportedMaps: ['森林牧场'],
    description: '树丛会遮挡玩家视野。当玩家接触树丛后，树丛在该玩家视野中会暂时变得半透明。',
  },
  果树丛: {
    type: '组件类',
    source: '地图组件',
    ...
    supportedMaps: ['森林牧场'],
    description:
      '果树丛具有{树丛}遮挡视野的效果。此外，果树丛上会间歇性结出果子，被角色碰触后会掉下，命中角色后会降低其移速和跳跃能力。',
  },
  章鱼: {
    type: 'NPC',
    source: '地图组件',
    ...
    supportedMaps: ['森林牧场'],
    description:
      '章鱼栖居在湖泊区域。当章鱼被吵醒时，将周期性挥动左侧/右侧触须，对命中的所有角色造成眩晕（不掉落老鼠），若命中猫角色则同时会使其暴露位置。章鱼苏醒一段时间后重新入睡。',
  },
  剑鱼: {
    type: 'NPC',
    source: '地图组件',
  ...
  珠宝展示柜: {
    ...
    move: false,
    gravity: false,
    aliases: ['珠宝柜', '首饰柜', '药水柜', '玻璃窗', '玻璃柜', '柜台', '大都会彩蛋房'],
    supportedMaps: ['大都会', '5V5大都会'],
    description:
      '珠宝展示柜内陈列了1瓶{隐身饮料}、1瓶{变身饮料}和2瓶{神秘饮料}，但初始有一层玻璃窗阻挡。角色投掷道具碰撞到玻璃窗时将削减展示柜的Hp（与命中{拳套盒}类似），Hp归零后玻璃窗将被击碎，随后角色可进入并拿取这些饮料。',
  },
  汽车: {
    type: ['平台类', '组件类'],
    source: '地图组件',
  ...
  站牌: {
    ...
    move: false,
    gravity: false,
    aliases: ['观光车', '车站', '观光车车站', '熊猫馆管道'],
    supportedMaps: ['熊猫馆'],
    description:
      '熊猫馆的五个区域通过站牌连接。站牌与{管道}类似，但使用所需时间及间隔更短，且无法被{猫是液体}进一步缩短使用时间（但仍可无视使用间隔）。角色使用站牌后会进入一段时间的“晕车”状态，期间移速小幅降低且无法使用站牌。',
  },
  大熊猫: {
    type: 'NPC',
    source: '地图组件',
    ...
    supportedMaps: ['熊猫馆'],
    description:
      '大熊猫在熊猫谷内活动。\n大熊猫初始为静坐状态，并遮挡该区域的{老鼠洞}使其无法放入{奶酪}。当大熊猫接触到{熊猫食物}时，将原地将其吃掉，累计吃掉4个食物后才会起身。\n大熊猫起身后将在该区域来回移动。若被投喂的4个食物均未被鼠方交互过，则不帮助任何阵营，反之则帮助鼠方阵营（在猫咪靠近时攻击对方，造成伤害和眩晕）。',
  },
  小熊猫: {
    type: 'NPC',
    source: '地图组件',
  ...
  鱼缸: {
    ...
    supportedMaps: ['御门酒店'],
    description:
      '鱼缸与{桶（地图组件）}类似，但是是透明的。角色跳入及跳出鱼缸时将清除并免疫由道具造成的反向、失明状态，跳出鱼缸后将在短时间内保持该效果但降低移速和跳跃能力。',
  },
  台灯: {
    type: ['组件类', '可交互'],
    source: '地图组件',
    ...
    gravity: false,
    supportedMaps: ['御门酒店'],
    description: '台灯可在关灯后提供一定范围的光照。角色可通过交互关闭/打开台灯。',
  },
  抽屉: {
    type: ['平台类', '组件类', '可交互'],
    source: '地图组件',
    ...
    detailedDescription:
      '抽屉初始为打开状态，角色可通过交互关闭/打开抽屉。抽屉被打开时会随机生成一个道具，且被打开期间其上方可被当做{平台}。抽屉每次被打开/关闭后5秒内无法再次被交互。抽屉有可能生成，括号为250连开四舍五入测出概率：\n{高尔夫球}（6%）、{冰（道具）}（9.2%）、{玻璃杯（道具）}（6.8%）、\n{碗（道具）}（5.6%）、{夹子（道具）}（2.8%）、{拍子}（5.2%）、{盘子}（7.2%）、\n{碟子}（8.4%）、{胡椒粉（道具）}（3.6%）、{香水瓶}（4.8%）、\n{灰色大花瓶}（8.8%）、{蓝白大花瓶}（2.4%）、{大鞭炮}（2.4%）、\n{小鞭炮}（6.8%）、{随机药水}（4.8%）、{遥控器}（4.8%）、空（8%）',
  },
  玉璧: {
    type: ['组件类', '可交互'],
    source: '地图组件',
    ...
    supportedMaps: ['天宫'],
    description:
      '玉璧可被鼠方角色持续缓慢推动/被猫方角色一次性大力推动，可被{佩克斯}主动技能推动少量距离。玉璧在坠落时碰到任意角色将对其造成伤害及眩晕，坠落至地面和部分平台时销毁。',
    specialImageUrl: '/images/maps/%E5%A4%A9%E5%AE%AB.png',
    collision: ['地面', '平台'],
    detailedDescription:
      '玉璧可被鼠方角色持续缓慢推动/被猫方角色一次性大力推动，可被{佩克斯}主动技能推动少量距离。玉璧在坠落时碰到任意角色将对其造成伤害及眩晕，[坠落至地面和平台时销毁，坠落至临时平台时不会销毁。](目前暂无法测量与墙壁的碰撞)',
  },
  香炉: {
    type: ['平台类', '组件类'],
    source: '地图组件',
